...
public class GuiMain13 {
	 ...
	 */
	private JPanel contentPanel; // 시작할 때 생성할 기본 판넬
	private JButton btnLoginPanel; // 보이는 판넬
	private JButton btnLogoutPanel;
	private Component currentComponent; // 현재 가지고 있는 컴퍼넌트 확인
