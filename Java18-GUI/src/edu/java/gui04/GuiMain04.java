...
public class GuiMain04 {
	...
	private void initialize() {
      ...
      btnPlus.addMouseListener(new MouseAdapter() {
         ...
         public void mouseClicked(MouseEvent e) {
        	 System.out.println("btnPlus : mousClicked()");
	...
	@Override
	public void keyPressed(KeyEvent e) {
	}});btnDivide.setFont(new Font("굴림",Font.BOLD|Font.ITALIC,48));btnDivide.setBounds(572,170,100,100);frame.getContentPane().add(btnDivide);

	JScrollPane scrollPane = new JScrollPane();scrollPane.setBounds(12,280,660,221);frame.getContentPane().add(scrollPane);

	textArea=new JTextArea();textArea.setFont(new Font("Monospaced",Font.PLAIN,48));scrollPane.setViewportView(textArea);
