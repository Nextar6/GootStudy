   ...
   private DefaultTableModel tableModel; // 테이블 형태를 만들 모델 변수
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ContactMain051 window = new ContactMain051();
