...
public class WrapperMain03 {
	...
	public static void main(String[] args) {
		 ...
		 // long 타입도 저장 할 수 있는 한계가 존재
		 
		 // BigInteger 생성자의 매개변수는 문자열
		 BigInteger big = new BigInteger("1234566555555555555555557477836272727");
		 System.out.println(big);
		 // BigInteger 의 사칙연산 방법 : add(), subtract(), multiply(), divide(), mod() 메소드 사용
