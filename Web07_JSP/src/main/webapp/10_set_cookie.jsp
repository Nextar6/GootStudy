...
<body>
	...
	- 쿠키 사용자 식별 3단계
		1) 서버스크립트는 이름, 나이, 식별숫자 등 정보를 쿠키에 설정하여 브라우저에 보냄
		2) 브라우저는 이 정보를 개인 PC에 저장
		3) 다음 접속 때 브라우저에서 웹 서버에 특정 요청을 할 경우, 이 정보를 서버에 전송하고
			서버는 정보를 사용자 식별 등의 용도로 사용
		- 주로 브라우저에서 사용자가 선택한 내용들을 저장(예. 특정 메세지를 다시 띄우지 않기 등)
	*/
